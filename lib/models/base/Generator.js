...
export default class Generator {
  ...
  get randomCharacterGenerator() {
    return this._randomCharacterGenerator !== undefined ? this._randomCharacterGenerator : this._parent.randomCharacterGenerator;
  }

  get quantifierMax() {
    return this._quantifierMax !== undefined ? this._quantifierMax : this._parent && this._parent.quantifierMax;
  }

  set quantifierMax(qm) {
    this._parent ? this._parent.quantifierMax : this._quantifierMax = qm;
  }
